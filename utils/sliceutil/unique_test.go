...
func Test_UniqueInts(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := Unique(tt.args.xi)
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Unique() []int failed. got=%v, want=%v", got, tt.want)
			}
		})
	}
}
...
func Test_UniqueStrings(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Unique() []strings failed. got=%v, want=%v", got, tt.want)
			}
		})
	}
}
...
func Test_UniqueFloat64s(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := Unique(tt.args.xf)
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Unique() []float64s failed. got=%v, want=%v", got, tt.want)
			}
		})
	}
}
...
func Test_UniqueInt32s(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := Unique(tt.args.xi)
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("Unique() []int32 failed. got=%v, want=%v", got, tt.want)
			}
		})
	}
}
